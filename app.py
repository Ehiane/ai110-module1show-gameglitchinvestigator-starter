...
# FIX ME: The logic breaks here
# Bug: New Game button was stuck on game over screen, preventing further interaction.
# Fix: Reset status to "playing" along with other state variables to allow the game to continue.
if new_game:
